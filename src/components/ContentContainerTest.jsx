...
//----------------------------------------------------------------------------------
    // Traitement particulier pour la rubrique "coups-critiques"
    ...
    // Pour les rubriques "post-bataille" et "compétences, sorts et prieres"
    if (["post-bataille", "compétences, sorts et prieres"].includes(currentMenu)) {
      const data =
        currentMenu === "post-bataille" ? postBattleDetails : competencesDetails;
        //---------------------------------------------------------------------------------------------------
      return (
        <Menu
          menuKey={currentMenu}
